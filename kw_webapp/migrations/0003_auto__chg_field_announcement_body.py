...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Announcement.body'
        db.alter_column('kw_webapp_announcement', 'body', self.gf('django.db.models.fields.TextField')())

    def backwards(self, orm):

        # Changing field 'Announcement.body'
        db.alter_column('kw_webapp_announcement', 'body', self.gf('django.db.models.fields.CharField')(max_length=100000))
    ...
    models = {
        ...
        'kw_webapp.announcement': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'pub_date': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'default': 'datetime.datetime(2014, 9, 2, 0, 0)'}),
