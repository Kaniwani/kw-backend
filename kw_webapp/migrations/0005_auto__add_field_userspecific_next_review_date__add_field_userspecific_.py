...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserSpecific.next_review_date'
        db.add_column('kw_webapp_userspecific', 'next_review_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'UserSpecific.burnt'
        db.add_column('kw_webapp_userspecific', 'burnt',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserSpecific.next_review_date'
        db.delete_column('kw_webapp_userspecific', 'next_review_date')

        # Deleting field 'UserSpecific.burnt'
        db.delete_column('kw_webapp_userspecific', 'burnt')
    ...
    models = {
        ...
        'kw_webapp.announcement': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'pub_date': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'default': 'datetime.datetime(2015, 1, 27, 0, 0)'}),
        ...
        'kw_webapp.userspecific': {
            ...
            'next_review_date': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
