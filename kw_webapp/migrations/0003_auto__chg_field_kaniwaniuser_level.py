...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'KaniWaniUser.level'
        db.alter_column('kw_webapp_kaniwaniuser', 'level', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'KaniWaniUser.level'
        db.alter_column('kw_webapp_kaniwaniuser', 'level', self.gf('django.db.models.fields.PositiveIntegerField')(default=1))
