...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('kw_webapp_synonym', (
            ...
            ('review', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['kw_webapp.UserSpecific'], null=True)),
        ))
    ...
    models = {
        ...
        'kw_webapp.announcement': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'pub_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 7, 1, 0, 0)', 'null': 'True'}),
        ...
        'kw_webapp.synonym': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'review': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['kw_webapp.UserSpecific']", 'null': 'True'}),
