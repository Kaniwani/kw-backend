...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserSpecific.synonyms'
        db.alter_column('kw_webapp_userspecific', 'synonyms', self.gf('django.db.models.fields.CharField')(null=True, max_length=255))

    def backwards(self, orm):

        # Changing field 'UserSpecific.synonyms'
        db.alter_column('kw_webapp_userspecific', 'synonyms', self.gf('django.db.models.fields.CharField')(max_length=255, default=''))
    ...
    models = {
        ...
        'kw_webapp.announcement': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'pub_date': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'default': 'datetime.datetime(2015, 2, 4, 0, 0)'}),
        ...
        'kw_webapp.userspecific': {
            ...
            'next_review_date': ('django.db.models.fields.DateTimeField', [], {'blank': 'True', 'null': 'True', 'default': 'datetime.datetime.now'}),
            'streak': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0'}),
            'synonyms': ('django.db.models.fields.CharField', [], {'blank': 'True', 'null': 'True', 'max_length': '255', 'default': 'None'}),
