...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserSpecific.unlock_date'
        db.add_column('kw_webapp_userspecific', 'unlock_date',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserSpecific.unlock_date'
        db.delete_column('kw_webapp_userspecific', 'unlock_date')
