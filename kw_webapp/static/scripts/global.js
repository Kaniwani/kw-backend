...
!function(a,b){"use strict"; true?!(__WEBPACK_AMD_DEFINE_FACTORY__ = (b),
...
function kwlog() {
  if (window.KWDEBUG === true || window.KW.user.name === 'duncantest' || // local dev
  window.KW.user.name === 'Subversity' || window.KW.user.name === 'Tadgh') {
    var _console;
...
!function (e) {
  !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(10)], __WEBPACK_AMD_DEFINE_RESULT__ = function (e) {
    return function () {
      function t(e, t, n) {
...
"use strict";
/* WEBPACK VAR INJECTION */(function($, simpleStorage) {

Object.defineProperty(exports, "__esModule", {
  value: true
});

var _pluralize = __webpack_require__(316);

var _pluralize2 = _interopRequireDefault(_pluralize);

var _kwlog = __webpack_require__(50);

var _kwlog2 = _interopRequireDefault(_kwlog);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var Favico = __webpack_require__(317);

var $navCount = void 0;
var $buttonCount = void 0;
var recentlyRefreshed = void 0;
  ...
  $.get('/kw/force_srs/').done(function (res) {
    ...
    if (count > 0) {
      ...
      if ($buttonCount.length) {
        $buttonCount.text((0, _pluralize2.default)('Review', count)).removeClass('-disabled');
      }
    }

    (0, _kwlog2.default)('Review count updated from server:', count);
...
function refreshReviews() {
  var _ref = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : { forceGet: false },
      forceGet = _ref.forceGet;

  $navCount = $('#navReviewCount');
  $buttonCount = $('#reviewCount');
  recentlyRefreshed = simpleStorage.get('recentlyRefreshed');

  var faviconCount = +$('#navReviewCount').text();
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(10), __webpack_require__(49)))
...
// adds to jQuery ability to serialize form into JS object (rather than a url params string)
// usage: let object = $(form).submit(function(ev) { ev.preventDefault(); $(this).serializeObject(); });
...
var _documentReady = __webpack_require__(126);

var _documentReady2 = _interopRequireDefault(_documentReady);

__webpack_require__(127);

var _invalidApiKey = __webpack_require__(310);

var _invalidApiKey2 = _interopRequireDefault(_invalidApiKey);

var _accordionContainer = __webpack_require__(311);

var _accordionContainer2 = _interopRequireDefault(_accordionContainer);

var _siteNav = __webpack_require__(313);
...
var _vocabulary = __webpack_require__(321);

var _vocabulary2 = _interopRequireDefault(_vocabulary);

var _levelVocab = __webpack_require__(322);

var _levelVocab2 = _interopRequireDefault(_levelVocab);
...
(0, _documentReady2.default)(function () {
  _invalidApiKey2.default.init();
  _accordionContainer2.default.init();
  _siteNav2.default.init();
  _login2.default.init();
  _home2.default.init();
  _vocabulary2.default.init();
  _levelVocab2.default.init();
  _reviews2.default.init();
  _contact2.default.init();
  _settings2.default.init();
  _summary2.default.init();
});
...
exports.default = api;
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(10), __webpack_require__(120)))
...
function init() {
  if ($('.accordion-list').length) {
    var resizeAccordion = function resizeAccordion(e) {
      $('.accordion-title').each(function (i, title) {
        var $title = $(title);
        if ($title.hasClass('is-expanded')) {
          var $content = $title.closest('dt').next();
          var _accH = $content.find('.content-inner').get(0).clientHeight;
          $content.css('max-height', _accH);
        }
      });
    };
    ...
    var switchAccordion = function switchAccordion(e) {
      ...
      var $title = $(this).closest('.accordionTrigger');
      var $content = $title.closest('dt').next();
      var $inner = $content.find('.content-inner');

      $content.hasClass('is-collapsed') ? setAccordionAria($title, $content, 'true') : setAccordionAria($title, $content, 'false');

      $title.toggleClass('is-expanded');
      $content.toggleClass('is-collapsed');

      var hash = $title.attr('href');
    ...
    var setAriaAttr = function setAriaAttr($el, ariaType, newProperty) {
      return $el.attr(ariaType, newProperty);
    };
...
function init() {
  ...
  var $menuButton = $('#js-mobilemenu-toggle');
...
var _refreshReviews = __webpack_require__(121);

var _refreshReviews2 = _interopRequireDefault(_refreshReviews);

var _strToBoolean = __webpack_require__(318);

var _strToBoolean2 = _interopRequireDefault(_strToBoolean);

var _kwlog = __webpack_require__(50);

var _kwlog2 = _interopRequireDefault(_kwlog);

var _timeago = __webpack_require__(319);
...
var _includeMedia = __webpack_require__(64);
...
Object.assign($.timeago.settings, _config2.default.timeago.settings);
Object.assign($.timeago.settings.strings, _config2.default.timeago.strings);

var KW = void 0;

function displayMessages() {
  (0, _kwlog2.default)('messages', KW.messages);
  KW.messages.forEach(function (_ref) {
    var text = _ref.text,
        level = _ref.level;
    return _toastr2.default[level](text);
  });
}

function updateReviewTime($el) {
  var now = Date.now();
  var next = KW.nextReview;
  var noWkVocab = +next === 0 && +KW.reviewCount < 1;
  ...
  if (noWkVocab) {
    ...
    // reviews ready!
    (0, _refreshReviews2.default)();
    clearInterval(KW.reviewTimer);
  } else {
    // update countdown timer
    var countdownText = $.timeago(KW.nextReview);
    $el.html('Next review: ' + countdownText);
  }
}

function init() {
  if (_includeMedia2.default.lessThan('md')) _config2.default.toastr.positionClass = 'toast-top-full-width';
  _toastr2.default.options = _config2.default.toastr;

  // let's update storage KW with any template provided changes
  KW = Object.assign(simpleStorage.get('KW') || {}, window.KW);
  KW.settings = (0, _strToBoolean2.default)(KW.settings);
  ...
  if (window.location.pathname === '/kw/') {
    var $refreshButton = $("#forceSrs");
    var $reviewButton = $("#reviewCount");

    if (KW.settings.onVacation === false) {
      updateReviewTime($reviewButton);
      KW.reviewTimer = setInterval(function () {
        return updateReviewTime($reviewButton);
      }, 10000 /* 10s */);
    }

    // event handlers
    $refreshButton.click(function () {
      return (0, _refreshReviews2.default)();
    });
...
function strToBoolean(obj) {
  if (obj == null) {
    (0, _kwlog2.default)('Invalid input provided to strToBoolean:', obj);
  } else {
...
"use strict";
/* WEBPACK VAR INJECTION */(function($, simpleStorage, notie) {
...
function init() {
  ...
  if ($levelList.length) {
    ...
    var $levels = $levelList.find('.level-card');
    var $reviewCount = $('.nav-link > .text > .count');
...
function handleLockClick(event) {
  ...
  var $icon = $(this);
  var $card = $icon.closest('.level-card');
  var level = $card.data('level-id');
  ...
  if ($card.hasClass('-unlocked')) {
    notie.confirm({
      ...
      submitCallback: function submitCallback() {
        return reLockLevel($card, $icon, level);
      }
    });
  } else {
...
function unLockLevel($card, $icon, level) {
  ...
  $.post('/kw/levelunlock/', { level: level, csrfmiddlewaretoken: CSRF }).done(function (res) {
    ...
    (0, _refreshReviews2.default)({ forceGet: true });
    simpleStorage.set('recentlyRefreshed', true, { TTL: 5000 });
  }).fail(function (res) {
    return handleAjaxFail(res, level, 'unlock');
  });
}
...
function reLockLevel($card, $icon, level) {
  ...
  $.post('/kw/levellock/', { level: level, csrfmiddlewaretoken: CSRF }).done(function (res) {
    ...
    return handleAjaxFail(res, level, 'lock');
  });
}
...
exports.default = api;
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(10), __webpack_require__(49), __webpack_require__(120)))
...
var _jump = __webpack_require__(323);
...
function init() {
  ...
  if (/vocabulary\/.+\//.test(window.location.pathname)) {
    var $cards = $('.vocab-list').find('.vocab-card');
...
function smoothScrollDeepLink(target) {
  ...
  if (el != null) {
    setTimeout(function () {
      return (0, _jump2.default)(el, { duration: 2000, offset: -50 });
    }, 1000);
...
function handleIconClick(event) {
  var $icon = $(this);
  var $card = $icon.closest('.vocab-card');
  ...
  function removeSynonym(id) {
    $.post('/kw/synonym/remove', {
      ...
      [$icon.closest('.kanji'), $icon.closest('.kanji').prev('.kana')].forEach(function (el) {
        return $(el).fadeOut(600);
      });
    }).always(function (res) {
      return (0, _kwlog2.default)(res);
    });
  }
...
var _wanakana = __webpack_require__(325);

var _wanakana2 = _interopRequireDefault(_wanakana);
...
var _modals = __webpack_require__(327);
...
var $reviewsLeft = $('#reviewsLeft');
var $reviewsDone = $('#reviewsDone');
var $reviewsCorrect = $('#reviewsCorrect');
var $progressBar = $('.progress-bar > .value');
var $meaning = $('#meaning');
var $srsIndicator = $('.streak > .icon');
var $userAnswer = $('#userAnswer');
var $answerPanel = $('#answerPanel');
var $submitButton = $('#submitAnswer');
var $ignoreButton = $('#ignoreAnswer');
var $srsUp = $('#srsUp > .content');
var $srsDown = $('#srsDown > .content');
var $reveal = $('.reveal');
var $detailKana = $('#detailKana');
var $detailKanji = $('#detailKanji');
var $synonymButton = $('#addSynonym');
var $synonymForm = $('#synonymForm');

var KW = void 0;
var currentVocab = void 0;
var remainingVocab = void 0;
var startCount = void 0;
var answer = void 0;
var correctTotal = 0;
var answeredTotal = 0;
...
var japRegex = /[\u3000-\u303f\u3040-\u309f\u30a0-\u30ff\u4e00-\u9faf\u3400-\u4dbf]/;

function onlyJapaneseChars(str) {
  return [].concat(_toConsumableArray(str)).every(function (char) {
    return japRegex.test(char);
  });
}

function onlyKanji(str) {
  return [].concat(_toConsumableArray(str)).every(function (char) {
    return char.charCodeAt(0) >= 19968 && char.charCodeAt(0) < 40879;
  });
}
...
function init() {
  ...
  // event listeners
  _wanakana2.default.bind(document.querySelector('#userAnswer'));
  _wanakana2.default.bind(document.querySelector('#newKana')); // new synonym form input
  _wanakana2.default.bind(document.querySelector('#newKanji')); // new synonym form input
  ...
  // DEBUG
  if (!!window.KWDEBUG) {
    $userAnswer.keydown(function (event) {
      (0, _kwlog2.default)('kp', event.which, String.fromCharCode(event.which));
    });
  }
}

function getSrsRankName(num) {
  return num > 8 ? 'burned' : num > 7 ? 'enlightened' : num > 6 ? 'master' : num > 4 ? 'guru' : 'apprentice';
}
...
function srsRankChange() {
  var _ref = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
      _ref$correct = _ref.correct,
      correct = _ref$correct === undefined ? false : _ref$correct;

  var rank = { val: currentVocab.streak, name: getSrsRankName(currentVocab.streak) };
  var adjustedRank = currentVocab.streak + (correct ? 1 : -1);
  var prevWrong = currentVocab.previouslyWrong;
  var newRank = { val: adjustedRank, name: getSrsRankName(adjustedRank) };
  var rankUp = !prevWrong && newRank.val > rank.val && newRank.name !== rank.name;
  var rankDown = newRank.val < rank.val && newRank.name !== rank.name;

  (0, _kwlog2.default)('--- srsRankChange---\n', 'rank:', rank, '\nnewRank:', newRank, '\nrankUp:', rankUp, '\nrankDown:', rankDown, '\nprevWrong:', prevWrong);
...
function updateKanaKanjiDetails() {
  $detailKana.find('.-kana').html(currentVocab.readings.map(function (reading) {
    return reading + ' </br>';
  }));
  $detailKanji.find('.-kanji').html(currentVocab.characters.map(function (kanji) {
    return kanji + ' </br>';
  }));
}
...
function compareAnswer() {
  (0, _kwlog2.default)('compareAnswer called');
  answer = $userAnswer.val().trim();

  if (isEmptyString(answer)) return;

  (0, _kwlog2.default)('Comparing', answer, 'with vocab item ' + currentVocab.user_specific_id + ':');
  ...
  if (onlyJapaneseChars(answer)) {
    ...
    var stripTildes = function stripTildes(str) {
      return str.replace('〜', '');
    };
    // Attempt to match disregarding tilde, otherwise keep answer as is
    answer = currentVocab.characters.filter(function (chars) {
      return stripTildes(chars) === stripTildes(answer);
    })[0] || answer;
  } else if (!_wanakana2.default.isHiragana(answer)) {
    // user used english that couldn't convert to full hiragana - don't proceed
    nonHiraganaAnswer();
    return;
  }

  var inReadings = function inReadings() {
    return $.inArray(answer, currentVocab.readings) !== -1;
  };
  var inCharacters = function inCharacters() {
    return $.inArray(answer, currentVocab.characters) !== -1;
  };
  var getMatchedReading = function getMatchedReading(hiraganaStr) {
    return currentVocab.characters[currentVocab.readings.indexOf(hiraganaStr)];
  };

  if (inReadings() || inCharacters()) {
    var advanceDelay = 800;

    markRight();

    // Fills the correct kanji into the input field based on the user's answers
    if (_wanakana2.default.isHiragana(answer)) {
...
function synonymModal() {
  (0, _kwlog2.default)('synonymModal called');
  disableShortcuts();

  var $form = $('#synonymForm');
  var $answerField = $(_wanakana2.default.isHiragana(answer) ? '#newKana' : '#newKanji');
  var $notAnswerField = $('.input').not($answerField);
  ...
  setTimeout(function () {
    return $notAnswerField.focus();
  }, 200);
}

function handleSynonymForm(ev) {
  (0, _kwlog2.default)('handleSynonymForm called');
  ev.preventDefault();
  var $this = $(this);
  var vocabID = currentVocab.user_specific_id;
  var $submitButton = $this.find('#synonymSubmit');
  var $validation = $this.find('.validation');
  var data = $this.serializeObject();

  if (Object.keys(data).every(function (key) {
    return data[key] !== '' && onlyJapaneseChars(data[key]);
  })) {
...
function addSynonym(vocabID) {
  ...
  $.post('/kw/synonym/add', {
    ...
    (0, _kwlog2.default)(res);
  });
}

function processAnswer() {
  var _ref3 = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
      _ref3$correct = _ref3.correct,
      correct = _ref3$correct === undefined ? false : _ref3$correct;

  (0, _kwlog2.default)('processAnswer called');

  var currentvocabID = currentVocab.user_specific_id;
...
function ignoreIncorrectAnswer() {
  var _ref4 = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
      _ref4$animate = _ref4.animate,
      animate = _ref4$animate === undefined ? true : _ref4$animate;

  (0, _kwlog2.default)('ignoreIncorrectAnswer called');

  if (ignored === false) {

    // using ignored flag to guard against multiple ignore submission spams before quiz ui has fully reset/rotated
    ignored = true;
    (0, _kwlog2.default)('ignoreIncorrectAnswer applied');
...
function ignoreCorrectAnswer() {
  (0, _kwlog2.default)('ignoreCorrectAnswer applied');
  $userAnswer.addClass('shake');
...
function revealAnswers() {
  ...
  if (!!kana) revealToggle($detailKana.find('.button'));else if (!!kanji) revealToggle($detailKanji.find('.button'));else {
...
function rotateVocab() {
  var _ref6 = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
      _ref6$correct = _ref6.correct,
      correct = _ref6$correct === undefined ? false : _ref6$correct;

  (0, _kwlog2.default)('rotateVocab called');
  ...
  var percentCorrect = Math.floor(correctTotal / answeredTotal * 100) || 0;
...
function enterPressed(event) {
  (0, _kwlog2.default)('enterPressed:', event, 'autoAdvancing:', autoAdvancing);
  ...
  if (ignored !== true && ev.which === 13) {
    ...
    switch (true) {
      ...
      case ev.which === 73 || ev.which === 105 || ev.which === 8 || ev.which === 191:
        ev.preventDefault();
        (0, _kwlog2.default)('case: I', 'event was:', ev);
      ...
      case ev.which === 220:
        ev.preventDefault();
        (0, _kwlog2.default)('case: \\', 'event was:', ev);
        if ($answerPanel.hasClass('-correct')) {
      ...
      default:
        (0, _kwlog2.default)('handleShortcuts switch fell through to default');
    }
  }
}
...
// this is a custom modified version of wanakana that overcomes the isHiragana failure bug for long hyphens (on entries like ハート形)
var wanakana,
    __indexOf = [].indexOf || function (a) {
  for (var b = 0, c = this.length; c > b; b++) {
    if (b in this && this[b] === a) return b;
  }return -1;
};wanakana = wanakana || {}, wanakana.version = "1.3.6", "function" == "function" && __webpack_require__(326) && !(__WEBPACK_AMD_DEFINE_ARRAY__ = [], __WEBPACK_AMD_DEFINE_RESULT__ = function () {
  return wanakana;
}.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__),
				__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__)), wanakana.LOWERCASE_START = 97, wanakana.LOWERCASE_END = 122, wanakana.UPPERCASE_START = 65, wanakana.UPPERCASE_END = 90, wanakana.HIRAGANA_START = 12353, wanakana.HIRAGANA_END = 12438, wanakana.KATAKANA_START = 12449, wanakana.KATAKANA_END = 12538, wanakana.LOWERCASE_FULLWIDTH_START = 65345, wanakana.LOWERCASE_FULLWIDTH_END = 65370, wanakana.UPPERCASE_FULLWIDTH_START = 65313, wanakana.UPPERCASE_FULLWIDTH_END = 65338, wanakana.defaultOptions = { useObseleteKana: !1, IMEMode: !1 }, wanakana.bind = function (a) {
  ...
  var c;if (null == a) return b;for (c in b) {
    null == a[c] && null != b[c] && (a[c] = b[c]);
  }return a;
}, wanakana._allTrue = function (a, b) {
  var c, d, e;for (d = 0, e = a.length; e > d; d++) {
    if (c = a[d], b(c) === !1) return !1;
  }return !0;
  ...
  var b, c, d, e, f, g;for (c = a.split(""), e = f = 0, g = c.length; g > f; e = ++f) {
  ...
  var b, c, d, e, f, g, h;for (c = [], h = a.split(""), f = 0, g = h.length; g > f; f++) {
  ...
  var b, c, d, e, f, g, h;for (d = [], h = a.split(""), f = 0, g = h.length; g > f; f++) {
  ...
  var c, d, e, f, g, h, i, j, k, l;for (b = wanakana._extend(b, wanakana.defaultOptions), g = a.length, k = [], e = 0, d = 0, h = 2, f = function f() {
    return a.substr(e, d);
  }, j = function j() {
  ...
  var d, e, f, g, h, i, j, k, l, m;for (null == c && (c = !1), b = wanakana._extend(b, wanakana.defaultOptions), l = a.length, j = [], g = 0, m = 3, h = function h() {
    return a.substr(g, f);
  }, i = function i(a) {
...
(function (root, factory) {
   ...
   */
  var stopVideos = function stopVideos(content, activeClass) {
...
function init() {
  ...
  if (/settings/.test(window.location.pathname)) {
    var saved = simpleStorage.get('settingsSaved');
    var $form = $('#settingsForm');
    var $button = $form.find('#submit-id-submit');
    ...
    if (!!saved) {
      ...
      setTimeout(function () {
        return _toastr2.default.success('Settings saved.');
      }, 300);
    }
...
function init() {
  if (/summary/.test(window.location.pathname)) {
    var pMatch = $('.correctPercent').text().match(/^\d*/);
    var percent = pMatch.length && pMatch[0];

    setTimeout(function () {
      return $('.percentage-bar .percentage').css('width', percent + '%');
    }, 200);
  }
}
