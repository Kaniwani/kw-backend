...
class SettingsForm(ModelForm):
    class Meta:
        model = Profile
        fields = ['api_key', 'level',  'follow_me', 'auto_advance_on_success', 'auto_expand_answer_on_success', 'auto_expand_answer_on_failure', 'only_review_above_wk_srs', 'on_vacation']
        help_texts = {
        ...
        labels = {
            ...
            "only_review_above_wk_srs": "Review only items that you have burned in WaniKani.",
